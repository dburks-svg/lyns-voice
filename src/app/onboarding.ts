...
export function showOnboarding(onDismiss: () => void): void {
  ...
  card.innerHTML = `
    <h2 style="margin:0 0 12px; font-size:16px; letter-spacing:0.06em; color:var(--accent, #3cf);">Welcome to LYNS Voice</h2>
    <p style="margin:0 0 10px;">LYNS Voice is the voice of Claude Code - the one you speak with is <b>Oracle</b>. The orb shows four states:</p>
    <ul style="margin:0 0 12px; padding-left:18px;">
      ...
      <li><b>Speaking</b> - Oracle reads the reply aloud.</li>
    </ul>
    ...
    <p style="margin:0 0 16px; opacity:0.8;">The first tap-to-talk downloads a ~57 MB speech model once (and the neural voice ~330 MB on first reply). Everything stays on your machine.</p>
